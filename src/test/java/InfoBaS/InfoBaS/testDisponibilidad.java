...
public class testDisponibilidad {
	...
	public void setUp() throws Exception {
		...
		disponi3 =  new DisponibilidadHoraria(3, 10, 0 , 15, 00);
		disponi4 =  new DisponibilidadHoraria(2, 10, 0 , 15, 00);
		...
		serv6.setDisponibilidadHoraria(disponi6);
		...
		String dateInString1 = "23-06-2016 11:20:56";
		...
		String dateInString6 = "24-06-2016 11:20:56";
		tiempoM = sdf6.parse(dateInString6);
	}

	@Test
	public void testBanco() {
		assertTrue("Fall� busqueda de banco por nombre",banco.disponibilidad(tiempo1, serv4));
		assertTrue("Fall� busqueda de banco por nombre",banco.disponibilidad(tiempo2, null));
		assertFalse("Fall� busqueda de banco por nombre",banco.disponibilidad(tiempoM, null));
	}

	@Test
	public void testCGP() {
		
		assertTrue("Fall� busqueda de CGP por nombre",cgp.disponibilidad(tiempo3, serv1));
		assertTrue("Fall� busqueda de CGP por tag",cgp.disponibilidad(tiempo4, null));
		assertFalse("Fall� busqueda de banco por nombre",cgp.disponibilidad(tiempoM, null));
	}
	
	@Test
	public void testComercio() {
		assertTrue("Fall� busqueda de comercio por nombre",comercio.disponibilidad(tiempo5, null));
	}
